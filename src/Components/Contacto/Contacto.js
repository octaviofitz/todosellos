...
const CompraBentonita = () => {
    ...
    return (
        <section className='compra-bentonita' id='contacto'>
            ...
            <h3 className='compra-bentonita-title'>CONTACTO</h3>
            <p className='compra-bentonita-data'>En TODO SELLOS queremos ayudarte a materializar tus ideas. Completa el formulario y nuestro equipo se pondrá en contacto para responder tus consultas y ofrecerte la mejor atención personalizada</p>
             </div>
